...
Python ve PyQt5 kullanılarak geliştirilmiş, lokasyon bazlı akıllı seyahat ve rota planlama masaüstü uygulaması. 
...
* **Güvenli ve Çevrimdışı Mimari:** SQLite entegrasyonu ve akıllı veritabanı tohumlama (Database Seeding) yapısı sayesinde internete bağlı olmadan stabil çalışma.
...
1. Repoyu bilgisayarınıza klonlayın:
   ```bash
   git clone [https://github.com/LockDock0/Gezi_Rehberi_Uygulamasi.git](https://github.com/LockDock0/Gezi_Rehberi_Uygulamasi.git)